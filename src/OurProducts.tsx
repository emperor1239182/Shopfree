...
export const OurProducts = ({ products }: product) => {
  ...
  return (
    <>
        ...
        <div className="intro">
          ...
          <div className="flex gap-3.5">
            <FiArrowLeft
              ...
              onClick={() => scrollLeft("ourProducts")}
            />
            <FiArrowRight
              className="rounded-xl bg-gray-200"
              onClick={() => scrollRight("ourProducts")}
            />
          </div>
        </div>
      </section>
      ...
      <div className="mt-5">
        <ul
          className="hide-scrollbar grid grid-rows-2 auto-cols-[minmax(160px,_1fr)] grid-flow-col gap-5 overflow-auto"
          ref={scrollRefs.ourProducts}
        >
          {products
            .filter((goods) =>
