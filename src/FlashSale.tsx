...
import type { product } from "./typeSet"; // ✅ type-only import
...
export const FlashSale = ({ products }: product) => {
  ...
  return (
    <>
        ...
        <div className="intro">
          <div className="flex gap-3 sm:gap-10 items-center">
            ...
            <div className="flex text-center text-[7px] font-semibold gap-1">
              ...
              <p>
                Hours <br />{" "}
                <span className="date">{timeLeft.hours} : </span>
              </p>
              <p>
                Minutes <br />{" "}
                <span className="date">{timeLeft.minutes} :</span>
              </p>
              <p>
                Seconds <br />{" "}
                <span className="date">{timeLeft.seconds}</span>
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3.5">
            <FiArrowLeft
              ...
              onClick={() => scrollLeft("flashSales")}
            />
            <FiArrowRight
              className="rounded-xl bg-gray-200"
              onClick={() => scrollRight("flashSales")}
            />
          </div>
        </div>
      </section>
      ...
      <div className="mt-5">
        <ul
          className="hide-scrollbar productList"
          ref={scrollRefs.flashSales}
        >
          {products
            .slice(1, 10)
            .filter((goods) =>
              ...
              <li key={goods.id}>
                <div className="w-40">
                  <div className="productDisplay">
                    ...
                    <p className="absolute left-1 top-1 text-[9px] px-2 text-white rounded bg-red-600">
                      {goods.discount}
                    </p>
                  </div>
